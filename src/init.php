...
function themecoder_block_cgb_block_assets() {
	// Styles.
	wp_enqueue_style(
		'themecoder_block-cgb-style-css', // Handle.
...
function themecoder_block_cgb_editor_assets() {
	// Scripts.
	wp_enqueue_script(
		'themecoder_block-cgb-block-js', // Handle.
	...
	// Styles.
	wp_enqueue_style(
		'themecoder_block-cgb-block-editor-css', // Handle.
		plugins_url( 'dist/blocks.editor.build.css', dirname( __FILE__ ) ), // Block editor CSS.
		array( 'wp-edit-blocks', 'themecoder_block-cgb-style-css' ), // Dependency to include the CSS after it.
